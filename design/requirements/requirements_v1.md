...
| **4** | Tốc độ tải trang & Xử lý tải cao | Tính hiệu quả (Hiệu năng) | Thời gian tải trang (Homepage, Product details) dưới 2 giây. Hệ thống hoạt động ổn định khi có lưu lượng truy cập đột biến (Flash Sale, Deals). | Tối ưu hóa truy vấn MongoDB và lưu trữ media qua Cloudinary. |
